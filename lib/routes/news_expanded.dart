...
class ExpandedNews extends StatefulWidget {
  ...
  const ExpandedNews({Key? key, required this.currentNews}) : super(key: key);

  @override
  _ExpandedNewsState createState() => _ExpandedNewsState();
}

class _ExpandedNewsState extends State<ExpandedNews> with AutomaticKeepAliveClientMixin<ExpandedNews>{
        ...
        slivers: <Widget>[
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              ...
              background: Hero(
                tag: widget.currentNews.imageUrl!,
                child: Image.network(
                                ...
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) => NewsWebView(
                                        sauce: widget.currentNews.readMoreUrl!),
                                  ),
                                );
                              },
                              style: ButtonStyle(
